...
public class CustomerAuthImpl implements UserDetailsService {
	 ...
	 * comes back may have a username that is of a different case than what was actually
	 * requested.
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if (Objects.nonNull(customerDetailsEntity)) {
			return new org.springframework.security.core.userdetails.User(customerDetailsEntity.getEmail(),
					customerDetailsEntity.getPassword(),
					customerDetailsEntity.getRoles()
						.stream()
